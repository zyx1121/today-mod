...
```
<sub>The band directly above the prompt: the running or next event with a countdown, deadlines ahead, reminders due. It ticks every minute and re-reads every five.</sub>
...
| `refreshMs` | number | `300000` | Milliseconds between re-reads. Floored at 60000. |
